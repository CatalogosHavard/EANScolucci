...
export default function EANGenerator() {
  ...
  }, [marca, eansGenerados, blacklist, contador]);
  ...
  const generarNuevoEAN = () => {
    ...
    // Intentar generar un EAN que no esté en la blacklist
    do {
      secuenciaActual++;
    ...
    } while (blacklist.includes(nuevoEAN) || eansGenerados.some(e => e.codigo === nuevoEAN));
    ...
    setEansGenerados([nuevoRegistro, ...eansGenerados]);
    setContador(secuenciaActual);
    mostrarMensaje(`EAN generado: ${nuevoEAN}`, 'success');
  };
